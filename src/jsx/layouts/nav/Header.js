                    ...
                    <ul className="timeline">
                      <li>
                        <div className="timeline-panel">
                          ...
                          <div className="media-body">
                            <h6 className="mb-1">Jermaine Sent you Photo</h6>
                      ...
                      <li>
                        <div className="timeline-panel">
                          ...
                          <div className="media-body">
                            <h6 className="mb-1">
                              Reminder : Time for Sarah to Checked Out
                            </h6>
                            <small className="d-block">
                              29 July 2020 - 02:26 PM
                            </small>
                      ...
                      <li>
                        <div className="timeline-panel">
                          ...
                          <div className="media-body">
                            <h6 className="mb-1">
                              Reminder : Time for Jake to Check In
                            </h6>
                            <small className="d-block">
                              {" "}
                              29 July 2020 - 02:26 PM
                    ...
                    <ul className="timeline">
                      ...
                      <li>
                        ...
                        >
                          ...
                          <h6 className="mb-0">
                            John asked a question about his stay{" "}
                          </h6>
                        </Link>
                      </li>
                      <li>
                        ...
                        >
                          ...
                          <h6 className="mb-0">
                            Jermaine left a review about his stay{" "}
                          </h6>
                        </Link>
                      </li>
                      <li>
                        ...
                        >
                          ...
                          <h6 className="mb-0">
                            New Hotel Reservation{" "}
                            <strong className="text-warning">#PA-1559.</strong>
                          </h6>
                          <p className="mb-0">
                            Quisque a consequat ante Sit amet magna at
                            volutapt...
                      ...
                      <li>
                        ...
                        >
                          <span>20 minutes ago</span>
                          <h6 className="mb-0">
                            Sarah has uploaded photos of her stay
                          </h6>
                        </Link>
                      </li>
                    </ul>
